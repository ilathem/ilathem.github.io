  ...
  return (
    <div className="bg-stone-600 w-screen h-screen flex items-center justify-center overflow-hidden font-['Comfortaa'] text-slate-200">
      ...
      >
        ...
        <motion.div
          className="row-start-3 col-span-2 flex flex-col items-center" 
        ...
        >
          ...
          <motion.p
            className="mb-2 h-10"
          >
            {['V', 'i', 'e', 'w', ' ', 'm', 'y', ' ', 'w', 'o', 'r', 'k'].map((letter, index) => {
              return (
                <motion.span
                  key={index}
          ...
          <motion.svg width="348" height="40" viewBox="0 0 348 79" fill="none" xmlns="http://www.w3.org/2000/svg"
