...
function App() {
  ...
  return (
    <div className="bg-stone-600 w-screen h-screen flex items-center justify-center overflow-hidden font-['Comfortaa'] text-slate-200">
      <motion.div
        className="w-5/6 h-5/6  bg-stone-800 rounded-2xl drop-shadow-2xl grid grid-cols-2 grid-rows-2 gap-2 p-5 max-w-screen-sm"
      ...
      >
        ...
        <motion.div className='row-start-2 col-span-2 flex flex-col items-center'>
          ...
          <motion.svg xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"
