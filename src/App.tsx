	...
	return (
		...
		>
			...
			>
				...
				<motion.div
					className='row-start-2 col-span-2 flex flex-col items-center justify-between'
				...
				>
					...
					<motion.svg
						...
						onClick={() => {
							window.open(
								'https://discordapp.com/users/ilathem#8147/',
								'_blank'
							);
						}}
					>
					...
					>
						...
						<motion.path
							...
							className={
								linkedHover
									? 'fill-[#069] transition-colors stroke-[#069]'
				...
				>
					<motion.p className='mb-2 h-10 text-lg'>
